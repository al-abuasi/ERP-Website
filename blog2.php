...
<head>
    <title>ERP Safety | Blog Post</title>
...
>
        <div class="container">
            <h1 class="pull-left">Blog Post</h1>
    	...
    	<div class="row blog-page blog-item">
        	...
        	<div class="col-md-9 md-margin-bottom-60">
                ...
                <div class="blog margin-bottom-40">
                    <h2><a href="blog_item_option1.php">Unify is an incredibly beautiful and fully responsive Bootstrap 3 Template</a></h2>
